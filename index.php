 ...
 <section class="imagen-contacto">
     ...
     <p>Llena el formulario de contacto y un asesor se pondrá en contacto con tigo a la brevedad</p>
     <a href="contacto.php" class="boton-amarillo-line">Contactános</a>
 </section>
 ...
 <div class="contenedor seccion seccion-inferior">
         ...
         <article class="entrada-blog">
             ...
             <div class="texto-entrada">
                 <a href="entrada.php">
                     ...
                     <p>Consejos para construir una terrasa en el techo de tu casa con los mejores materiales y ahorrando dinero</p>
                 </a>
             </div>
         </article>
     ...
     <section class="testimoniales">
         ...
         <div class="testimonial">
             <blockquote>
                 El personal se comportó de una exelente forma, muy buena atención
 ...
 <?php
    ...
    // var_dump(incluirTemplate("footer"));
    ?>